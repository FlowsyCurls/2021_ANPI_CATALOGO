...
function ejemplo
     ...
     # Aproximacion.
     [valor, vector, error]=potencia(A, x0, iterMax, tol);
     
     # Print.
     fprintf('El valor propio de mayor magnitud es :  %d\n',valor);
     fprintf('El vector propio correspondiente es :  [');
...
function [valor, vector, err] = potencia(A, x0, iterMax, tol)
     #{
    ...
    for n=1 : iterMax
         ...
         xk_n = (1/ck)*yk;
         error = [ error, norm(xk_n-xk) ];  % Error.
         xk = xk_n;
